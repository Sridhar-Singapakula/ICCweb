...
const Vaani = () => {
  const eventsData = [
    ...
    ,
    {
      ...
      color: 'fb',
      icon: 'fa fa-map-marker',
      eventName: 'Literature and Language learning Workshops',
      // description:
      //   'Milestone Admin Dashboard contains C3 graphs, flot graphs, data tables, calendar, drag & drop and ion slider.',
      tags: ['Design', 'Admin'],
    }
    ,
    {
      ...
      color: 'fb',
      icon: 'fa fa-map-marker',
      eventName: 'Story Writing and Storytelling workshops',
      // description:
      //   'Milestone Admin Dashboard contains C3 graphs, flot graphs, data tables, calendar, drag & drop and ion slider.',
      tags: ['Design', 'Admin'],
    }
  ...
  return (
    <div>
        ...
        <div className="section-title" style={{marginTop:"100px",marginBottom:"-50px"}}>
          <h2>The Indian Languages Club of IIT Bombay </h2>
        </div>
        <div>
        <ul className='ul_'>
          <li className='li_'>
            <a href="https://www.linkedin.com/company/comedy-cons/">
             <i className="bi bi-linkedin" aria-hidden="true"></i>
              <span> - @vaani_iitb</span>
            </a>
          </li>
          <li className='li_'>
            <a href="https://www.facebook.com/vaani.iitb">
              <i className="bi bi-facebook" aria-hidden="true"></i>
              <span> - @vaani_iitb</span>
            </a>
          </li>
          <li className='li_'>
            <a href="https://www.youtube.com/channel/VaaniIITBombay">
          ...
          <li className='li_'>
            <a href="https://www.instagram.com/vaani_iitb/">
        ...
        <div className="col-lg-4 align-items-stretch order-1 order-lg-2 img"  data-aos="zoom-in" data-aos-delay="150">
          ...
          <div className="col-lg-7 d-flex flex-column justify-content-center align-items-stretch order-2 order-lg-1" style={{alignItems:"start"}}>
            <div className="content">
              <h3 style={{fontSize:"30px",}} ><strong>The Indian Languages Club of IIT Bombay </strong></h3>
              
              <img src={{pngi}} width="200" height="150"></img>
              <p>
              No matter where a person comes from, one always has a special connection with one's mother tongue. Here, at Vaani - The Indian Languages Club of IIT Bombay, we try to embrace that connection through writing, reading and appreciating. As a part of the club, you can expect to be immersed in the multiverse of rich Indian literature. We conduct a plethora of events and workshops catering to various genres like poetry, word games, creative writing, storytelling, lyrics writing, and so on. Writing is one of the most beautiful ways to express oneself; and anyone who writes to express is a writer in oneself. While a majority of our current literary content is Hindi and Urdu based, we are constantly trying to broaden our horizons by including poetry and stories penned in various Indian languages on our blog and providing platforms like open mic and informal meets called Goshthi to express yourself in a literary manner. Help
us in this goal by being a part of Vaani, where we teach you the craft, encourage you to read, motivate you to express, and inspire you to write, but most importantly, have a lot of fun!
            ...
            <div className='club_info' style={{display:"flex",marginTop:"20px",alignItems:"center"}}>
              ...
              <div style={{marginLeft:"30px"}}>
                ...
                Institute Indian Languages Secretary
                </p>
