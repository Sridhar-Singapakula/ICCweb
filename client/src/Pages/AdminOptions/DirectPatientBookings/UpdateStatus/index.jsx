...
import { updateTestStatusOfDirect } from '../../../../redux/patientSlice/apiCalls';





const Popup = ({ patientId,testId,onClose }) => {
    ...
    value === ""
        ...
        const handleSubmit = async (e) => {
            ...
            if (Object.keys(errors).length === 0) {
                ...
                updateTestStatusOfDirect(patientId,data,dispatch);
                onClose()
            } else {
  ...
  return (
    <div className="popup-container">
      <div className="popup-content">
        <h2>Update Status for Patient: {patientId}</h2>
