...
const CreateCompetition = () => {
    ...
    const columns = ["Position","hostelNo","Points"];
	...
	const handleSubmit = async (e) => {
		...
		try {
            setIsFetching(true);
            const url = process.env.REACT_APP_API_URL + "/GCFinalResultsNoPartRoutes";
  ...
  return (
    <div className='partici_'>
        <h1 style={{color:"white",fontWeight:"600"}}>Declare Final Results Without participants</h1>
                      <TextField
						label="Name"
                        name="name"
