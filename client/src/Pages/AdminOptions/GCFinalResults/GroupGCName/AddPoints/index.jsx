...
const AddParticipantToCompetition = ({ competitionId, onClose }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (Object.keys(errors).length === 0) {
            setIsFetching(true);
            const url = process.env.REACT_APP_API_URL + `/GroupGCRank/${competitionId}/add-participant`;
    ...
    return (
        <div className="popup_container">
            <h2 style={{marginTop:"30px",fontSize:"25px",marginBottom:"25px"}}>Add Participants of the Competition</h2>
